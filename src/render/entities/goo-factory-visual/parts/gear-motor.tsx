  ...
  return (
    <group position={[dim.driveCenterX, 0, dim.driveCenterZ]}>
      <mesh castShadow receiveShadow position={[0, baseY, 0]}>
        <boxGeometry args={[0.46, 0.14, 0.34]} />
        {createMaterial(PALETTE.motorBase, 'iron')}
      </mesh>
      <mesh castShadow receiveShadow position={[0, baseY + 0.075, 0]}>
        <boxGeometry args={[0.42, 0.02, 0.3]} />
        {createMaterial(PALETTE.motorBaseTop, 'iron')}
      </mesh>
      ...
      <mesh castShadow receiveShadow position={[motorOffsetX, pedestalCenterY, 0]}>
        <boxGeometry args={[0.22, pedestalHeight, 0.24]} />
        {createMaterial(PALETTE.motorBase, 'iron')}
      </mesh>
      <mesh castShadow receiveShadow position={[motorOffsetX, pedestalTopY, 0]}>
      ...
      <mesh
        ...
        rotation={[0, 0, Math.PI / 2]}
      >
        <cylinderGeometry args={[motorRadius + 0.01, motorRadius + 0.01, 0.04, 20]} />
      ...
      <mesh
        ...
        rotation={[0, 0, Math.PI / 2]}
      >
        <torusGeometry args={[motorRadius * 0.6, 0.01, 6, 18]} />
        {createMaterial(PALETTE.pumpHighlight, 'iron')}
      </mesh>
      ...
      <group ref={gearRef} position={[gearX, motorBodyY, 0]}>
        <mesh castShadow receiveShadow rotation={[0, 0, Math.PI / 2]}>
          <cylinderGeometry args={[gearRadius * 0.8, gearRadius * 0.8, gearThickness, 24]} />
        ...
        {Array.from({ length: GEAR_TEETH }, (_, index) => {
          ...
          return (
            <mesh
              ...
              rotation={[angle, 0, 0]}
            >
              <boxGeometry args={[gearThickness, 0.075, 0.06]} />
              {createMaterial(PALETTE.gearTeeth, 'iron')}
            </mesh>
          );
        })}
        <mesh castShadow receiveShadow rotation={[0, 0, Math.PI / 2]}>
          <torusGeometry args={[gearRadius * 0.8, 0.012, 8, 26]} />
          {createMaterial(PALETTE.gearRim, 'iron')}
        </mesh>
        ...
        <mesh castShadow receiveShadow position={[-0.04, 0, 0]} rotation={[0, 0, Math.PI / 2]}>
